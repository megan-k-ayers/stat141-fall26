...
Before coming to lab today, please read the following material from ModernDive. 

-   MD Chapter 1 (skip section 1.1.1, unless you feel strongly about using the desktop app RStudio rather than RStudio Server)



## Accessing Labs on RStudio Server (we'll go over this during lab)
