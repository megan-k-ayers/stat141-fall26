...
**a.** Use the `rep_sample_n` function to collect 1000 virtual samples of size *n* = 15 from our population. Save these 1000 virtual samples into an object named `my_n15_1000rep`. Use **seed 910** to generate your sample. **Include your code, but you don't need to print the output of the code.**
...
**f.** Which sampling distribution looked more bell shaped and symmetric: the one built on n = 15 or 50?
...
**a.** What distinguishes bootstrap distributions from sampling distributions? What part of the code above makes the result a *bootstrap* distribution?
