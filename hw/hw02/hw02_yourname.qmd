...
For this problem, we'll look at the `detectors` dataset from the article *"GPT Detectors Are Biased Against Non-Native English Writers"*^[**GPT Detectors Are Biased Against Non-Native English Writers.** *Weixin Liang*, *Mert Yuksekgonul*, *Yining Mao*, *Eric Wu*, *James Zou.* [CellPress Patterns](https://doi.org/10.1016/j.patter.2023.100779)].

a.  The code following code does some data wrangling to produce a graphic. Starting with `humans_only <- detectors %>%`, give a line-by-line explanation of what the code does, using language accessible to someone who hasn't had prior coding experience.
