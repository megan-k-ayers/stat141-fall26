...
**e.** List out the assumptions required for linear regression, and write whether or not those assumptions have been met for this model (*Hint*: reference the graphs you made above and at the end of Lab 4 for this model).
