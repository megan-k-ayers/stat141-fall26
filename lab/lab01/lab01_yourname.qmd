...
**b.** In the environment pane, click the little broom icon in the upper bar. Click yes on the
window that opens. What happened to the environment? What happens if you now try to run your chunks from Exercise 1 step (f)?
