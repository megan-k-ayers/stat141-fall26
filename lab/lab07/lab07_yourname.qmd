...
**b.** Using the bootstrap distribution that you created above, calculate a 95% confidence interval for the proportion of US Adults who favor increasing the number of electric vehicle charging stations in the U.S. using the **PERCENTILE method.** 
...
**c.** Use the same sample and the same bootstrap distribution from part (a) -- `sample_ev` and `boot_ev` -- find a 95% confidence interval now using the **STANDARD ERROR method** for the proportion of US Adults who favor increasing the number of electric vehicle charging stations in the U.S.
