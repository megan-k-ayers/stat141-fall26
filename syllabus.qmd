...
-   **Lab assignments**:
    ...
    - Solutions for lab assignments will be posted at the end of the day on Thursdays as a reference for the following homework assignment.
...
-   **Quizzes**:
    ...
    - You will have the opportunity to submit quiz revisions, and make-up quizzes (in the event of absences) for partial credit.
    - Your two lowest quiz grades will be dropped, but dropped quizzes may only include one that you were absent for and did not make up.
