...
[Stat 141 \| Fall 2026 <br> Monday, Week 3]{.custom-subtitle}
:::
:::::
...
- The statement *"it will rain at 9am in Portland on 9/14"* is *an* event, but not one for the die-rolling process.
:::
:::
...
::: {.incremental}
- We expect the proportion of heads [in a large number of coin flips]{.underline} to be close to 0.5
:::
:::
...
- By definition, complementary events are mutually exclusive
...
## Activity: Coffee or Tea?

A survey was given to 100 Stat 141 students in 2017. Some results are summarized below:
...
::: fragment
We calculated this intuitively before, but we can generalize.
:::
...
::: {.callout-note icon=false style="font-size: 0.9em;"}
## Definition: Probability
The **probability** of a particular **event** is the proportion of times the event would occur, if we observed the random process an *arbitrarily large* number of times.
:::
...
::: {.callout-note .fragment icon=false style="font-size: 0.9em;"}
## Law of Large Numbers
Observed proportions may deviate from expected probabilities when $n$ is small, but the deviation decreases as $n$ increases. Think about the proportion of heads you expect from 10 vs 1,000,000 coin flips.
:::
...
-   More probability rule practice with activities
