...
- Quiz tomorrow during lab
    - Arrive on time to use the full 30 mins
    - Bring something to write with
    - Be mindful of others when arriving / if finished early
    
<br>
    
- Math/Stats colloquium tomorrow - student summer research! 
...
- The probability that a student who is a sophomore (B) prefers coffee (A):
...
::: {.fragment}
**Q:** Were the events "preferring coffee" (A) and "being a sophomore at Reed" (B) independent?
:::
...
::: {.fragment}
One approach: Rearrange our formula for conditional probability!
