...
![](img/bootstrap_shapes1.png)

:::

::: {.column .fragment width=19% fragment-index=1}

![](img/bootstrap_shapes2.png)

:::

::: {.column .fragment width=31% fragment-index=2}

![](img/bootstrap_shapes3.png)

:::

::: {.column .fragment width=30% fragment-index=3}

![](img/bootstrap_shapes4.png)
...
- Same result, save time: Just sample *with replacement* from the one original sample to get "bootstrap samples"
...
::: fragment
**Q:** How does this general process of generating a bootstrap distribution differ from the process of generating the *sampling* distribution?
:::
...
- **How We'll Answer:**
  ...
  - Estimate the sampling distribution (and therefore uncertainty) using the bootstrap distribution.
...
- Sampling and Bootstrap have slightly different means, but have similar standard deviations!
    - **Q**: Why are the means different? 
    - **Q**: Does it make sense that the standard deviations are similar? Why is this helpful? 

:::

- Mean of Sampling is the *true* mean, while the Mean of Bootstrap is the *sample* mean
    - These differ because of sampling variability
...
::: {.nonincremental}
- The standard deviations are similar because the sample is representative of the population, and both distributions use samples of the same size
    - **This is great!!** We have something very similar to $SE$ using only our one sample! 
