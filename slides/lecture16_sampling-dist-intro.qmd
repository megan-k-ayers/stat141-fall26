...
[Stat 141 \| Fall 2026 <br> Wednesday, Week 6]{.custom-subtitle}
:::
:::::
...
4. Add the value of the average/mean as a dot on the chalkboard.
5. Repeat steps 1 - 4 an additional **seven** times.

\smallskip

Each group should have calculated 8 averages from 8 different samples of 10 cards!
:::
...
## Recap: Sampling Distributions and Statistical Inference
...
- **Sampling distributions** show how widely our statistic can range across samples
    ...
    - We'll spend a couple more days learning about sampling distributions, then will learn how to use them to make inferences! 
