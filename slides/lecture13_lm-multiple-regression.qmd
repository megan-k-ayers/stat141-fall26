...
![](img/culmen_depth.png){fig-align='center' width=85%}
...
-   Side note: this type of graph is really helpful when including both a categorical and quantitative variable in a linear model! 
...
-   **Coefficient interpretation?**
    - $\beta_1 \cdot x_{\textrm{Bill Depth}}$ is particularly tricky
...
- We'll practice a very common transformation in HW 5 - the **log transformation**
- **Q**: Why is it still called a *linear* regression if the model also handles curved relationships?
...
- We've compared **fixed and varying slope models**, and seen how to visualize each in `ggplot2` (`geom_parallel_slopes()` vs regular `geom_smooth()`)
- We've seen how **transformations** can help us proceed with linear models even when our data appear to have nonlinear relationships 
