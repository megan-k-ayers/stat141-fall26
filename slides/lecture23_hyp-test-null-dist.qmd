---
pagetitle: "Hypothesis Testing II: More Examples, 1 vs 2 sided"
editor: source
draft: true
format: 
  revealjs:
...
[Stat 141 \| Fall 2026 <br> Friday, Week 9]{.custom-subtitle}
:::
:::::
...
- Practice defining and simulating null distributions
...
## Hypothesis Testing Steps: ESP {style="font-size:0.9em;"}
...
::: nonincremental
- **Q**: How should we write out $H_0$ and $H_a$ in terms of population parameters? (*Hint: recall that we use $r$ for correlation*)

- **Q**: How would we expect the sample statistic to behave under $H_0$?
:::


------------------------------------------------------------------------

## Null Distribution in `R` via Permutation
...
### Another Example: Crocodile Smiles
...
::: nonincremental
- **Q**: How should we write out $H_0$ and $H_a$ in terms of population parameters? (*Hint, we can write the population mean leniency score for smilers as $\mu_S$*).
