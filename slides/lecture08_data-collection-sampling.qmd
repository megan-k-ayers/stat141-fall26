...
-   Quick clarification: independent vs disjoint
...
![](img/cloud_population.png){width="50%" fig-align="center"}
...
- The 2020 census cost about $13.7B!!
...
-   Three ways to obtain a representative sample:
    ...
    - **Cluster random sampling** (select *some* hats from a group of many *similar* hats, take their cards)
