...
[Stat 141 \| Fall 2026 <br> Monday, Week 4]{.custom-subtitle}
:::
:::::
...
- I'll post Quiz 1 scores/feedback on Gradescope around noon
- Quiz 2 is this Thursday, material from HW 3 
...
## Quiz Revisions Logistics

Who is eligible:

- If you scored below a 75%, you can revise your work for 50% credit back up to a 75%
    - Ex. If you scored 60%, you can earn up to a 75% after revisions
    - Ex. If you scored 30%, you can earn up to a 65% after revisions
- You must have taken a quiz during lab to revise it
...
- Review your in-class quiz, scores, and feedback on Gradescope
- For any questions where you lost points, each revision item should include:
    1. Name of the question part (ex. "Q2(a)")
    2. Brief explanation (1-2 sentences) of where the original response went wrong
    3. Your revised, **complete** solution (even if your work was partially correct before)
- Submit your compiled revisions as a PDF on Gradescope by **Monday 9/28 at 11:59pm**
...
- You **can (should!)** use all of your regularly permitted course resources as you revise (online slides, your notes, your assignments)
- You **can not** discuss the quiz or revisions with other students or with the course assistants
- You **can** ask me clarifying questions in office hours
...
![](img/sampling_bias_comic.png){width="45%" fig-align="center"}
...
- The sample size is huge! But large $n$ can still have sampling bias.
- The response rate (less than 25%) is not the problem here - it's who is responding!
- Gallup predicted Roosevelt would win based on a survey of only **50,000** people
...
For these goals we'll differentiate between the roles of these variables:
...
-   Those working in quantitative fields can be **very** sensitive to implications of causal claims - be careful with your vocab choices ("caused" vs "is associated with" vs "trends with"). 
...
-   Common features:
    ...
    -   **Deception**: When information is witheld or participants are mislead in order to prevent bias or maintain natural reactions
...
-   **Another Example**: Experiment in Lab 2! 
...
- **Randomized experiments**:
    - A study where researchers actively control an explanatory variable (i.e. randomize a "treatment")
    - Can lead directly to causal conclusions 
- **Observational study**: 
    - A study where researchers observe and collect data but do not actively control them
    - Typically cannot lead to causal conclusions due to confounding variables - can be possible with more assumptions and advanced techniques 
    - Can still generate meaningful evidence for research questions
    
<br> 

- Note that both of these types of studies can involve surveys, and both can involve *random selection of participants* or cases
