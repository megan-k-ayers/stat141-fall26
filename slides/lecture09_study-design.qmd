...
**Note:** The response rate (less than 25%) is not the problem here - it's who is responding!
...
- **Randomized experiments**:
    ...
    - Can lead to causal conclusions 
- **Observational study**: 
    - A study where researchers observe and collect data but do not actively control them
    - Generally cannot lead to causal conclusions due to confounding variables, unless we make more assumptions and use more advanced causal inference methods
